                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <div class="salePrice">
                            ...
                            <div class="li"><a href="#" @click="rentpriceClick">1000元以下</a></div>
                            <div class="li"><a href="#">1000-1500元</a></div>
                            <div class="li"><a href="#">1500-2000元</a></div>
                            <div class="li"><a href="#">2000-3000元</a></div>
                            <div class="li"><a href="#">3000元以上</a></div>
                        </div>
                    </ul>
                </div>
                <!-- Split button -->
