...
<head>
    ...
    <link rel="stylesheet" href="./css/wx_rent.css" />
</head>
<body>
<div id="app">
    <header>
                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    <li><a href="#" @click="pageToSell">二手房</a></li>
                                    <li><a href="#">租房</a></li>
                                    <li><a href="#">经纪人</a></li>
                                </ul>
                            </div>
    ...
    <section class="findPanel">
        <div class="line">
            <div class="col-xs-12">
                ...
                <div class="btn-group">
                    <button class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        月租价格<span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu">
                        <div class="salePrice">
                            <div class="li"><a href="#" class="aactive" @click="rentprice1Click">不限</a></div>
                            <div class="li"><a href="#" @click="rentprice2Click">1000元以下</a></div>
                            <div class="li"><a href="#" @click="rentprice3Click">1000-1500元</a></div>
                            <div class="li"><a href="#" @click="rentprice4Click">1500-2000元</a></div>
                            <div class="li"><a href="#" @click="rentprice5Click">2000-3000元</a></div>
                            <div class="li"><a href="#" @click="rentprice6Click">3000元以上</a></div>
                        </div>
                    </ul>
                </div>
                <!-- Split button -->
                    ...
                    <div class="dataBox">
                        <div class="houseData row" v-for="item, index in propertyList"  :key="index" v-cloak>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-9 detail">
                                ...
                                <ul class="showPrice">
                                    <h3 class="red">{{ item.rentprice + item.rentunitname }}</h3>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<script src="./js/wx_rent.js"></script>
</body>
</html>
